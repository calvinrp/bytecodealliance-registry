...
use url::Url;
use warg_api::v1::content::{ContentDigestSources, ContentError, ContentSource};
...
async fn get_content(
...
) -> Result<Json<ContentDigestSources>, ContentApiError> {
    ...
    Ok(Json(ContentDigestSources { content_sources }))
}
